...
description: 自动分析项目结构并生成适配 Cursor, Claude Code, Windsurf 等主流 Vibe Coding 软件的 Manifest 配置文件（CLAUDE.md, AGENTS.md, .cursorrules）。使用场景：初始化项目、迁移 Vibe Coding 配置、优化 AI Agent 项目上下文。
---
