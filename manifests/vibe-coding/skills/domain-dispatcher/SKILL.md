...
|---------------|--------|-------|-------|-----------|
| "UI", "design", "component", "layout", "accessibility", "responsive" | UI Design | `frontend-design` | `canvas-design`, `ui-ux-pro-max-skill`, `taste-skill` | `vibe-coding-ui-design.mdc` |
...
| "frontend", "css", "i18n", "a11y", "component library" | Frontend | `frontend-patterns` | `frontend-design`, `ui-ux-pro-max-skill`, `taste-skill` | `vibe-coding-frontend.mdc` |
